...
Compiler.prototype.compileTemplate = function () {
  ...
  if (size(this.complexSetters) > 0) {
    ...
    code += '  var __cache__ = view.__cache__ = {};\n';
    code += '  var λ = {\n';
...
Compiler.prototype.textNode = function (node) {
  ...
  var textParser = this.compileExpression(new Splitter(node.data), function (code) {
...
Compiler.prototype.compileExpression = function (expression, callback) {
